...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi, I'm enquiring about Roots Dental Care. I'd like to know more about your services and book an appointment."
);

function FloatingWhatsApp() {
  return (
    <a
      href={`https://wa.me/918904481179?text=${WHATSAPP_MESSAGE}`}
      target="_blank"
